...
<head>
		...
		<link rel="stylesheet" href="{{ asset('assets/libs/font-material/css/material-design-iconic-font.min.css')}}">
		<link rel="stylesheet" href="{{ asset('assets/libs/nivo-slider/css/nivo-slider.css')}}">
		<link rel="stylesheet" href="{{ asset('assets/libs/nivo-slider/css/animate.css')}}">
		<link rel="stylesheet" href="{{ asset('assets/libs/nivo-slider/css/style.css')}}">
		<link rel="stylesheet" href="{{ asset('assets/libs/owl.carousel/assets/owl.carousel.min.css')}}">
		<link rel="stylesheet" href="{{ asset('assets/libs/slider-range/css/jslider.css')}}">
	...
	<body class="home home-1">
							...
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="topbar-right d-flex justify-content-end">
									...
									<div class="dropdown language">
										<div class="dropdown-toggle" data-toggle="dropdown">
											<img src="{{ asset('assets/img/language-en.jpg')}}" alt="Language English">
										</div>
										<div class="dropdown-menu">
											<div class="item">
												<a href="#" title="Language English"><img src="{{ asset('assets/img/language-en.jpg')}}" alt="Language English"> English</a>
											</div>
											<div class="item">
												<a href="#" title="Language French"><img src="{{ asset('assets/img/language-fr.jpg')}}" alt="Language French"> French</a>
											</div>
										</div>
									</div>
											...
											<table>
												<tbody>
													<tr>
														<td class="product-image">
															<a href="product-detail-left-sidebar.html">
																<img src="{{ asset('assets/img/product/7.jpg')}}" alt="Product">
															</a>
														</td>
														<td>
													...
													<tr>
														<td class="product-image">
															<a href="product-detail-left-sidebar.html">
																<img src="{{ asset('assets/img/product/6.jpg')}}" alt="Product">
															</a>
														</td>
														<td>
															<div class="product-name">
					...
					<ul class="menu">
						...
						<li class="dropdown">
							...
							<div class="dropdown-menu">
								<ul>
									<li class="has-image">
										<img src="{{ asset('assets/img/product/product-category-1.png')}}" alt="Product Category Image">
										<a href="product-grid-left-sidebar.html" title="Vegetables">Vegetables</a>
									</li>
									<li class="has-image">
										<img src="{{ asset('assets/img/product/product-category-2.png')}}" alt="Product Category Image">
										<a href="product-grid-left-sidebar.html" title="Fruits">Fruits</a>
									</li>
									<li class="has-image">
										<img src="{{ asset('assets/img/product/product-category-3.png')}}" alt="Product Category Image">
										<a href="product-grid-left-sidebar.html" title="Bread">Bread</a>
									</li>
									<li class="has-image">
										<img src="{{ asset('assets/img/product/product-category-4.png')}}" alt="Product Category Image">
										<a href="product-grid-left-sidebar.html" title="Juices">Juices</a>
									</li>
									<li class="has-image">
										<img src="{{ asset('assets/img/product/product-category-5.png')}}" alt="Product Category Image">
				...
				<div class="section slideshow">
					<div class="tiva-slideshow-wrapper">
						<div id="tiva-slideshow" class="nivoSlider">
							<a href="#">
								<img class="img-responsive" src="{{ asset('assets/img/slideshow/home1-slideshow-1.jpg')}}" alt="Slideshow Image">
							</a>
							<a href="#">
								<img class="img-responsive" src="{{ asset('assets/img/slideshow/home1-slideshow-2.jpg')}}" alt="Slideshow Image">
							</a>
							<a href="#">
								<img class="img-responsive" src="{{ asset('assets/img/slideshow/home1-slideshow-3.jpg')}}" alt="Slideshow Image">
							</a>
						</div>
					</div>
				</div>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
								<div class="intro-left">
									<div class="intro-item">
										<p><img src="{{ asset('assets/img/intro-icon-1.png')}}" alt="Intro Image"></p>
										<h4>Always Fresh</h4>
										<p>Lorem ipsum dolor sit amet, consectetur elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
									</div>
									
									<div class="intro-item">
										<p><img src="{{ asset('assets/img/intro-icon-3.png" alt="Intro Image')}}"></p>
										<h4>Super Healthy</h4>
										<p>Lorem ipsum dolor sit amet, consectetur elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
									</div>
								</div>
							...
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
								<div class="effect">
									<a href="#">
										<img class="img-responsive" src="{{ asset('assets/img/intro-1.png')}}" alt="Intro Image">
									</a>
								</div>
							</div>
							...
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
								<div class="intro-right">
									<div class="intro-item">
										<p><img src="{{ asset('assets/img/intro-icon-2.png')}}" alt="Intro Image"></p>
										<h4>100% Natural</h4>
										<p>Lorem ipsum dolor sit amet, consectetur elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
									</div>
									
									<div class="intro-item">
										<p><img src="{{ asset('assets/img/intro-icon-4.png')}}" alt="Intro Image"></p>
								...
								<div class="row">
									...
									<div class="col-md-6 col-xs-12 product-right">
										<div class="product-image">
											<a href="product-detail-left-sidebar.html">
												<img src="{{ asset('assets/img/product/18.jpg')}}" alt="Product Image">
											</a>
										</div>
									</div>
								</div>
							...
							<div class="product-item">
								<div class="row">
									...
									<div class="col-md-6 col-xs-12">
										<div class="product-image">
											<a href="product-detail-left-sidebar.html">
												<img src="{{ asset('assets/img/product/40.jpg')}}" alt="Product Image">
											</a>
										</div>
									</div>
								</div>
							...
							<div class="product-item">
								<div class="row">
									...
									<div class="col-md-6 col-xs-12">
										<div class="product-image">
											<a href="product-detail-left-sidebar.html">
												<img src="{{ asset('assets/img/product/11.jpg')}}" alt="Product Image">
											</a>
										</div>
									</div>
								</div>
							...
							<ul>
								<li class="active">
									<a data-toggle="tab" href="#all-products">
										<img src="{{ asset('assets/img/product/product-category-0.png')}}" alt="All Product">
										<span>All Products</span>
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#vegetables">
										<img src="{{ asset('assets/img/product/product-category-1.png')}}" alt="Vegetables">
										<span>Vegetables</span>
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#fruits">
										<img src="{{ asset('assets/img/product/product-category-2.png')}}" alt="Fruits">
										<span>Fruits</span>
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#bread">
										<img src="{{ asset('assets/img/product/product-category-3.png')}}" alt="Bread">
										<span>Bread</span>
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#juices">
										<img src="{{ asset('assets/img/product/product-category-4.png')}}" alt="Juices">
										<span>Juices</span>
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#tea">
										<img src="{{ asset('assets/img/product/product-category-5.png')}}" alt="Tea">
										<span>Tea</span>
									</a>
								</li>
							</ul>
							...
							<div role="tabpanel" class="tab-pane fade in active" id="all-products">
								<div class="products owl-theme owl-carousel">
									...
									<div class="product-item">
										<div class="product-image">
											<a href="product-detail-left-sidebar.html">
												<img src="{{ asset('assets/img/product/33.jpg')}}" alt="Product Image">
											</a>
										</div>
										...
										<div class="block-content">
											<div class="row margin-0">
												<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 padding-0">
													<a href="#">
														<img src="{{ asset('assets/img/instagram-1.png')}}" alt="Instagram Image">
													</a>
												</div>
												<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 padding-0">
													<a href="#">
														<img src="{{ asset('assets/img/instagram-2.png')}}" alt="Instagram Image">
													</a>
												</div>
												<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 padding-0">
													<a href="#">
														<img src="{{ asset('assets/img/instagram-3.png')}}" alt="Instagram Image">
													</a>
												</div>
												<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 padding-0">
													<a href="#">
														<img src="{{ asset('assets/img/instagram-4.png')}}" alt="Instagram Image">
													</a>
												</div>
												<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 padding-0">
													<a href="#">
														<img src="{{ asset('assets/img/instagram-5.png')}}" alt="Instagram Image">
													</a>
												</div>
												<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 padding-0">
													<a href="#">
														<img src="{{ asset('assets/img/instagram-6.png')}}" alt="Instagram Image">
													</a>
												</div>
												<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 padding-0">
													<a href="#">
														<img src="{{ asset('assets/img/instagram-7.png')}}" alt="Instagram Image">
													</a>
												</div>
												<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 padding-0">
													<a href="#">
														<img src="{{ asset('assets/img/instagram-8.png')}}" alt="Instagram Image">
													</a>
												</div>
											</div>
										</div>
						...
						<div class="row">
							...
							<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 align-right">
								<div class="payment">
									...
									<img src="{{ asset('assets/img/payment.png')}}" alt="Payment">
								</div>
							</div>
						</div>
					</div>
		...
		<script src="{{ asset('assets/libs/jquery.countdown/jquery.countdown.js')}}"></script>
		<script src="{{ asset('assets/libs/nivo-slider/js/jquery.nivo.slider.js')}}"></script>
		<script src="{{ asset('assets/libs/owl.carousel/owl.carousel.min.js')}}"></script>
		<script src="{{ asset('assets/libs/slider-range/js/tmpl.js')}}"></script>
		<script src="{{ asset('assets/libs/slider-range/js/jquery.dependClass-0.1.js')}}"></script>
		<script src="{{ asset('assets/libs/slider-range/js/draggable-0.1.js')}}"></script>
		<script src="{{ asset('assets/libs/slider-range/js/jquery.slider.js')}}"></script>
		<script src="{{ asset('assets/libs/elevatezoom/jquery.elevatezoom.js')}}"></script>
